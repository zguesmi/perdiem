...
Nothing on the page shows the money. A viewer sees a payout cap and a payout, but never watches
900 USDC enter escrow and 900 USDC leave it.
...
- [ ] A new `VITE_USDC_ADDRESS` is required, named in `ui/README.md` and in both `.env` examples.
